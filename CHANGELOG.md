...
- Added [`.github/smoke-test/dataset.yaml`](.github/smoke-test/dataset.yaml) with download URLs and MD5 checksums for that public dataset (for the upcoming HTML smoke-test workflow).
